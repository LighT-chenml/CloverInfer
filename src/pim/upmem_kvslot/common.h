...
#endif
#ifndef KVSLOT_MAX_SLOTS_PER_DPU
...
#define KVSLOT_CMD_AV_GROUPED_BATCH 15U
#define KVSLOT_CMD_QK_SLOT_GROUPED_BATCH 16U

#define KVSLOT_MAX_GROUP_SEGMENTS 8U
...
#define KVSLOT_QK_SLOT_MODE_CONTEXT_FUSED_UNNORMALIZED 3U
